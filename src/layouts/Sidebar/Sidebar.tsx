...
export const Sidebar = () => {
      ...
      menuitems.map((mainlevel) => {
        if (mainlevel.Items) {
          mainlevel.Items.map((items) => {
            ...
            if (location.pathname === "/sash/preview/" || location.pathname === "/sash/preview") {
  ...
  return (
    <Fragment>
      <div className="app-sidebar" onMouseOver={() => Onhover()} onMouseOut={() => Outhover()}>
                    ...
                    <li className={`slide ${menuItem.selected ? "is-expanded" : ""}`} key={i}>
                      {menuItem.type === "sub" ? (
                        ...
                        >
                          ...
                          {menuItem.badge ? <span className={menuItem.badge}>{menuItem.badgetxt}</span> : ""}
                                      ...
                                      {childrenItem.children.map((childrenSubItem, key) => (
                                        <li className={`${childrenSubItem.selected ? " is-expanded" : ""}`} key={key}>
                                          {childrenSubItem.type === "link" ? (
                                            <NavLink to={childrenSubItem.path + "/"} className="sub-slide-item">
