...
function changePrimaryColor(input: any) {
  ...
  const dynamicBackgroundColor = document.querySelectorAll("input.color-primary-light");
...
function darkPrimaryColor(input: any) {
  ...
  const dynamicBackgroundColor = document.querySelectorAll("input.color-primary-dark");
...
function transparentPrimaryColor(input: any) {
  ...
  const dynamicBackgroundColor = document.querySelectorAll("input.color-primary-transparent");
...
function BgImgTransparentPrimaryColor(input: any) {
  ...
  const dynamicPrimaryImgTransparent = document.querySelectorAll("input.color-primary-img-transparent");

  SwitcherData.dynamicBgImgTransparentPrimaryColor(dynamicPrimaryImgTransparent, input);
                ...
                <div className="predefined_styles">
                  ...
                  <div className="swichermainleft">
                    ...
                    <div className="skin-body switch_section">
                      ...
                      <div className="switch-toggle d-flex mt-2">
                        <Link className="bg-img1" to="#" onClick={() => SwitcherData.bgimage1()}>
                          <img src={require("../../assets/images/media/bg-img1.jpg")} alt="Bg-1" id="bgimage1" />
                        </Link>
                        <Link className="bg-img2" to="#" onClick={() => SwitcherData.bgimage2()}>
                          <img src={require("../../assets/images/media/bg-img2.jpg")} alt="Bg-2" id="bgimage2" />
                        </Link>
                        <Link className="bg-img3" to="#" onClick={() => SwitcherData.bgimage3()}>
                          <img src={require("../../assets/images/media/bg-img3.jpg")} alt="Bg-3" id="bgimage3" />
                        </Link>
                        <Link className="bg-img4" to="#" onClick={() => SwitcherData.bgimage4()}>
                          <img src={require("../../assets/images/media/bg-img4.jpg")} alt="Bg-4" id="bgimage4" />
                        </Link>
                      </div>
                    </div>
                  </div>
