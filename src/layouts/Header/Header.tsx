...
const Header = () => {
  ...
  const PrivateInfo = useAppSelector((store) => store.auth.PrivateInfo);
                ...
                <Navbar.Collapse className="" id="navbarSupportedContent-4">
                  <div className="d-flex order-lg-2">
                    ...
                    <div className="d-flex country">
                      <Link to="#" onClick={handleShow} className="nav-link icon text-center">
                    ...
                    <Dropdown className="d-flex shopping-cart">
                      <Dropdown.Toggle variant="" className="nav-link icon text-center no-caret">
                        ...
                        <span className="badge bg-secondary header-badge">4</span>
                      </Dropdown.Toggle>
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <PerfectScrollbar style={{ height: "300px" }}>
                          <Dropdown.Item href={`/Ecommerce/shoppingcart`} className="d-flex p-4">
                            ...
                            <div className="ms-auto text-end d-flex fs-16">
                              <span className="fs-16 text-dark d-none d-sm-block px-4">$438</span>
                          ...
                          <Dropdown.Item href={`/Ecommerce/shoppingcart`} className="d-flex p-4">
                            ...
                            <div className="ms-auto text-end d-flex">
                              <span className="fs-16 text-dark d-none d-sm-block px-4">$867</span>
                              <span className="fs-16 btn p-0 cart-trash">
                                <i className="fe fe-trash-2 border text-danger brround d-block p-2"></i>
                              </span>
                            </div>
                          ...
                          <Dropdown.Item href={`/Ecommerce/shoppingcart`} className="d-flex p-4">
                            ...
                            <div className="ms-auto text-end d-flex">
                              <span className="fs-16 text-dark d-none d-sm-block px-4">$323</span>
                              <span className="fs-16 btn p-0 cart-trash">
                                <i className="fe fe-trash-2 border text-danger brround d-block p-2"></i>
                              </span>
                            </div>
                          ...
                          <Dropdown.Item href={`/Ecommerce/shoppingcart`} className="d-flex p-4">
                            ...
                            <div className="ms-auto text-end d-flex">
                              <span className="fs-16 text-dark d-none d-sm-block px-4">$456</span>
                              <span className="fs-16 btn p-0 cart-trash">
                                <i className="fe fe-trash-2 border text-danger brround d-block p-2"></i>
                              </span>
                            </div>
                        ...
                        <div className="dropdown-footer">
                          <Link className="btn btn-primary btn-pill w-sm btn-sm py-2" to={`/Ecommerce/checkout`}>
                    ...
                    <Dropdown className="d-flex notifications">
                      <Dropdown.Toggle variant="" className="nav-link icon no-caret">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <div className="notifications-menu">
                          <Dropdown.Item className="d-flex" href={`/Pages/notificationlist`}>
                            ...
                            <div className="mt-1">
                              <h5 className="notification-label mb-1">New Application received</h5>
                    ...
                    <Dropdown className="d-flex message">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        <div className="drop-heading border-bottom">
                          <div className="d-flex">
                            <h6 className="mt-1 mb-0 fs-16 fw-semibold text-dark">You have 5 Messages</h6>
                            <div className="ms-auto">
                          ...
                          <Dropdown.Item className="d-flex" href={`/apps/chat`}>
                            ...
                            <div className="wd-90p">
                              <div className="d-flex">
                                ...
                                <small className="text-muted ms-auto text-end">7:55 pm</small>
                              </div>
                        ...
                        <div className="dropdown-divider m-0"></div>
                        <Dropdown.Item to="#" className="text-center p-3 text-muted">
                          See all Messages
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        <div className="drop-heading">
                          <div className="text-center">
                            <h5 className="text-dark mb-0 fs-14 fw-semibold">{PrivateInfo.username}</h5>
                            <small className="text-muted">{PrivateInfo.email}</small>
                          </div>
                        </div>
                        <div className="dropdown-divider m-0"></div>
                        ...
                        <Dropdown.Item className="dropdown-item" href={`/auth/lockscreen`}>
